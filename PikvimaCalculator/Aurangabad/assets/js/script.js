...
function calculate_vima() {
	...
	if (crop_name == "Black Gram (Urad)") {
	...
	else if (crop_name == "Groundnut (Pea Nut)") {
		...
		premium = premium_8 * area;
		insured_amount = insured_8* area;
	}
	else if (crop_name == "Sorghum (Jowar/Great Millet)") {
		premium = premium_9 * area;
		insured_amount = insured_9* area;
	}
	else if (crop_name == "Soybean (Bhat)") {
		premium = premium_10 * area;
		insured_amount = insured_10* area;
	}
